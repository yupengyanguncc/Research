...
# 查找返回箭头（橙色）
ax.add_patch(FancyArrowPatch((x_table+0.13, y_table), (x_keys+0.09, key_y[highlight_idx]), color='#ff8800', lw=4, arrowstyle='simple'))

os.makedirs('assets/image', exist_ok=True)
plt.savefig('assets/image/hash_table_search_process.png', bbox_inches='tight', dpi=300)
plt.close()
